...
**方法 3: 手动安装**
```bash
git clone https://github.com/OSSKn4w7/xiaohongshu-skill.git
cp -r xiaohongshu-skill/xiaohongshu ~/.openclaw/workspace/skills/
...
- **GitHub**: https://github.com/OSSKn4w7/xiaohongshu-skill
